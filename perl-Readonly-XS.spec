%{?scl:%scl_package perl-Readonly-XS}
%{!?scl:%global pkg_name %{name}}

Name:		%{?scl_prefix}perl-Readonly-XS
Version:	1.05
Release:	18%{?dist}
...
Requires:	%{?scl_prefix}perl(Readonly) >= 1.02

# Obsolete/provide old -tests subpackage (can be removed in F19 development cycle)
Obsoletes:	%{?scl_prefix}perl-Readonly-XS-tests < %{version}-%{release}
Provides:	%{?scl_prefix}perl-Readonly-XS-tests = %{version}-%{release}
...
%changelog
* Thu Dec 05 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.05-18
- Updated filters of dependencies
- Resolves: rhbz#1038681

* Thu Nov 21 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.05-17
- Rebuilt for SCL
